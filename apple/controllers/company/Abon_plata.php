...
class Abon_plata extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $company_data['sub_start'] = $date = (new DateTime($company_data['sub_start']))->format('d.m.Y H:i:s');
        $company_data['sub_end'] = $date = (new DateTime($company_data['sub_end']))->format('d.m.Y H:i:s');
