...
function init_template(){
    ...
    var colorsArray = [
        ...
        ["blue1","#504de4","#504de4","#504de4"],
        ["blue2","#5D9CEC","#504de4","#1a64c6"],
        ...
        var call_charts_to_page = function(){
            new Chart(document.getElementById("pie-chart"), {
                ...
                data: {
                    ...
                    datasets: [{
                        backgroundColor: ["#504de4", "#4FC1E9", "#A0D468"],
    ...
    if(!$('.offline-message').length){
        $('#page').append('<p class="offline-message bg-red2-dark color-white center-text uppercase ultrabold">Нет соединения</p>');
        $('#page').append('<p class="online-message bg-green1-dark color-white center-text uppercase ultrabold">Соединение восстановлено</p>');
    }
